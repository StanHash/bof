...
_080F4198:
	...
	b _080F41B8
	.align 2, 0
_080F41B0: .4byte Unk_0812D128
_080F41B4: .4byte Unk_0812D14C
_080F41B8:
	ldr r0, [r7]
	bl func_080D7D08
	add sp, #4
...
_080F4248:
	...
	b _080F4268
	.align 2, 0
_080F4260: .4byte Unk_0812D164
_080F4264: .4byte Unk_0812D14C
_080F4268:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080F4270
func_080F4270: @ 0x080F4270
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F4288
func_080F4288: @ 0x080F4288
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F42B2:
	...
	THUMB_FUNC_START func_080F42BC
func_080F42BC: @ 0x080F42BC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F42DC
func_080F42DC: @ 0x080F42DC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080F435C:
	...
	THUMB_FUNC_START func_080F4364
func_080F4364: @ 0x080F4364
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F43A4
func_080F43A4: @ 0x080F43A4
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
...
_080F4430:
	...
	THUMB_FUNC_START func_080F4438
func_080F4438: @ 0x080F4438
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080F4450:
	...
	THUMB_FUNC_START func_080F4458
func_080F4458: @ 0x080F4458
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F44D4
func_080F44D4: @ 0x080F44D4
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
...
_080F45DC:
	...
	THUMB_FUNC_START func_080F45E4
func_080F45E4: @ 0x080F45E4
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F4754:
	...
	THUMB_FUNC_START func_080F475C
func_080F475C: @ 0x080F475C
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
