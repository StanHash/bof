...
_080FF2B8:
	...
	b _080FF2D8
	.align 2, 0
_080FF2D0: .4byte Unk_0812DB84
_080FF2D4: .4byte Unk_0812DBA4
_080FF2D8:
	ldr r0, [r7]
	bl func_080D7D08
	add sp, #4
...
_080FF36C:
	...
	b _080FF38C
	.align 2, 0
_080FF384: .4byte Unk_0812DBBC
_080FF388: .4byte Unk_0812DBA4
_080FF38C:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080FF394
func_080FF394: @ 0x080FF394
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FF3AC
func_080FF3AC: @ 0x080FF3AC
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FF3F0
func_080FF3F0: @ 0x080FF3F0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FF480:
	...
	THUMB_FUNC_START func_080FF488
func_080FF488: @ 0x080FF488
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FF4CA:
	...
	THUMB_FUNC_START func_080FF4D4
func_080FF4D4: @ 0x080FF4D4
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FF4FE:
	...
	THUMB_FUNC_START func_080FF508
func_080FF508: @ 0x080FF508
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
