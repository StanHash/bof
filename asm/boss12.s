...
_080F6340:
	...
	b _080F6360
	.align 2, 0
_080F6358: .4byte Unk_0812D2D0
_080F635C: .4byte Unk_0812D2F4
_080F6360:
	ldr r0, [r7]
	bl func_080D7D08
	add sp, #4
	...
	THUMB_FUNC_START func_080F6370
func_080F6370: @ 0x080F6370
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F645C:
	...
	b _080F647C
	.align 2, 0
_080F6474: .4byte Unk_0812D30C
_080F6478: .4byte Unk_0812D2F4
_080F647C:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080F6484
func_080F6484: @ 0x080F6484
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F64EC
func_080F64EC: @ 0x080F64EC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080F6558:
	...
	THUMB_FUNC_START func_080F6560
func_080F6560: @ 0x080F6560
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F6578
func_080F6578: @ 0x080F6578
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080F65AE:
	...
	THUMB_FUNC_START func_080F65BC
func_080F65BC: @ 0x080F65BC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F65D8
func_080F65D8: @ 0x080F65D8
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
