...
_080F6E40:
	...
	b _080F6E60
	.align 2, 0
_080F6E58: .4byte Unk_0812D3AC
_080F6E5C: .4byte Unk_0812D3D0
_080F6E60:
	ldr r0, [r7]
	ldr r1, [r7]
	ldrh r2, [r0, #0x2c]
	...
	THUMB_FUNC_START func_080F6E84
func_080F6E84: @ 0x080F6E84
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F6FE8:
	...
	b _080F7008
	.align 2, 0
_080F7000: .4byte Unk_0812D3E8
_080F7004: .4byte Unk_0812D3D0
_080F7008:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080F7010
func_080F7010: @ 0x080F7010
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F704A:
	...
	THUMB_FUNC_START func_080F7054
func_080F7054: @ 0x080F7054
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F7084
func_080F7084: @ 0x080F7084
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F7108: .4byte 0x00001030
	...
	THUMB_FUNC_START func_080F710C
func_080F710C: @ 0x080F710C
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F715C
func_080F715C: @ 0x080F715C
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F71C8
func_080F71C8: @ 0x080F71C8
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F71E0
func_080F71E0: @ 0x080F71E0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F722C:
	...
	THUMB_FUNC_START func_080F7234
func_080F7234: @ 0x080F7234
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080F72A0:
	...
	THUMB_FUNC_START func_080F72A8
func_080F72A8: @ 0x080F72A8
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F72D6:
	...
	THUMB_FUNC_START func_080F72E0
func_080F72E0: @ 0x080F72E0
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F7300
func_080F7300: @ 0x080F7300
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F73CE:
	...
	THUMB_FUNC_START func_080F73D8
func_080F73D8: @ 0x080F73D8
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F7410
func_080F7410: @ 0x080F7410
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
