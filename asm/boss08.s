...
_080F1810:
	...
	b _080F1830
	.align 2, 0
_080F1828: .4byte Unk_0812CEF8
_080F182C: .4byte Unk_0812CF1C
_080F1830:
	ldr r0, [r7]
	bl func_080D7D08
	add sp, #4
...
_080F18C4:
	...
	b _080F18E4
	.align 2, 0
_080F18DC: .4byte Unk_0812CF34
_080F18E0: .4byte Unk_0812CF1C
_080F18E4:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080F18EC
func_080F18EC: @ 0x080F18EC
	push {r7, lr}
	sub sp, #0x10
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F19BC
func_080F19BC: @ 0x080F19BC
	push {r4, r7, lr}
	sub sp, #0x10
	mov r7, sp
	str r0, [r7]
...
_080F1AC8:
	...
	THUMB_FUNC_START func_080F1AD0
func_080F1AD0: @ 0x080F1AD0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F1B76:
	...
	THUMB_FUNC_START func_080F1B80
func_080F1B80: @ 0x080F1B80
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080F1BF8:
	...
	THUMB_FUNC_START func_080F1C00
func_080F1C00: @ 0x080F1C00
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080F1C18
func_080F1C18: @ 0x080F1C18
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
