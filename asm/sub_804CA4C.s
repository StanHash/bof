...
.syntax unified
	...
	THUMB_FUNC_START func_0804CA4C
func_0804CA4C: @ 0x0804CA4C
	push {r4, r7, lr}
	sub sp, #0x20
	mov r7, sp
	str r0, [r7]
...
_0804CC3C:
	...
	THUMB_FUNC_START func_0804CC44
func_0804CC44: @ 0x0804CC44
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_0804CC78: .4byte Unk_03003100
	...
	THUMB_FUNC_START func_0804CC7C
func_0804CC7C: @ 0x0804CC7C
	push {r4, r7, lr}
	sub sp, #0x18
	mov r7, sp
	str r0, [r7]
