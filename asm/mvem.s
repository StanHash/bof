...
_080EC258:
	...
	b _080EC278
	.align 2, 0
_080EC270: .4byte Unk_0812C9B8
_080EC274: .4byte Unk_0812C9E0
_080EC278:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080EC280
func_080EC280: @ 0x080EC280
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080EC2B6:
	...
	THUMB_FUNC_START func_080EC2C0
func_080EC2C0: @ 0x080EC2C0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	ldr r0, _080EC2D8
...
_080EC35C:
	...
	b _080ECAA0
	.align 2, 0
_080EC374: .4byte Unk_0812C9FC
_080EC378: .4byte Unk_0812C9E0
...
_080EC758:
	...
	b _080EC836
	.align 2, 0
_080EC7C8: .4byte Unk_083976D0
_080EC7CC: .4byte Unk_03006760
_080EC7D0: .4byte Unk_03006B10
_080EC7D4:
	ldr r0, [r7]
	movs r1, #0xf
	ands r0, r1
...
_080EC9C0:
	...
	b _080EC34E
	.align 2, 0
_080ECA88: .4byte Unk_03001C80
_080ECA8C: .4byte 0x0000010B
_080ECA90: .4byte 0x0000010F
_080ECA94: .4byte Unk_03006AF0
_080ECA98: .4byte Unk_0821831C
_080ECA9C: .4byte Unk_03006B10
_080ECAA0:
	add sp, #0x1c
	pop {r4, r5, r6, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080ECAA8
func_080ECAA8: @ 0x080ECAA8
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	ldr r0, _080ECB70
...
_080ECB66:
	...
	b _080ECBC8
	.align 2, 0
_080ECB70: .4byte Unk_03004150
_080ECB74: .4byte 0x00000B68
_080ECB78: .4byte Unk_03006AB0
_080ECB7C: .4byte Unk_03006B10
_080ECB80: .4byte Unk_030055D0
_080ECB84: .4byte Unk_03006AF0
_080ECB88: .4byte Unk_0821831C
_080ECB8C:
	ldr r0, [r7, #8]
	ldrb r1, [r0]
	str r1, [r7]
