...
_080FDD94:
	...
	b _080FDDB4
	.align 2, 0
_080FDDAC: .4byte Unk_0812D9B0
_080FDDB0: .4byte Unk_0812D9D0
_080FDDB4:
	ldr r0, [r7]
	bl func_080D7D08
	add sp, #4
...
_080FDEA8:
	...
	b _080FDEC8
	.align 2, 0
_080FDEC0: .4byte Unk_0812D9E8
_080FDEC4: .4byte Unk_0812D9D0
_080FDEC8:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080FDED0
func_080FDED0: @ 0x080FDED0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FDF60
func_080FDF60: @ 0x080FDF60
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080FDFCE:
	...
	THUMB_FUNC_START func_080FDFDC
func_080FDFDC: @ 0x080FDFDC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FDFF4
func_080FDFF4: @ 0x080FDFF4
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FE08C:
	...
	THUMB_FUNC_START func_080FE09C
func_080FE09C: @ 0x080FE09C
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080FE0F8:
	...
	THUMB_FUNC_START func_080FE108
func_080FE108: @ 0x080FE108
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
...
_080FE1F6:
	...
	THUMB_FUNC_START func_080FE200
func_080FE200: @ 0x080FE200
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080FE25C:
	...
	THUMB_FUNC_START func_080FE26C
func_080FE26C: @ 0x080FE26C
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FE2D6:
	...
	THUMB_FUNC_START func_080FE2E0
func_080FE2E0: @ 0x080FE2E0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FE322:
	...
	THUMB_FUNC_START func_080FE32C
func_080FE32C: @ 0x080FE32C
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FE3A8
func_080FE3A8: @ 0x080FE3A8
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
