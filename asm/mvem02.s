...
_080FE518:
	...
	THUMB_FUNC_START func_080FE5AC
func_080FE5AC: @ 0x080FE5AC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FE5BC
func_080FE5BC: @ 0x080FE5BC
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FE5DE:
	...
	THUMB_FUNC_START func_080FE5EC
func_080FE5EC: @ 0x080FE5EC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
