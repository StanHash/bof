...
_080FEB58:
	...
	b _080FEB78
	.align 2, 0
_080FEB70: .4byte Unk_0812DAB8
_080FEB74: .4byte Unk_0812DAD8
_080FEB78:
	ldr r0, [r7]
	bl func_080D7D08
	add sp, #4
...
_080FEC2C:
	...
	b _080FEC4C
	.align 2, 0
_080FEC44: .4byte Unk_0812DAF0
_080FEC48: .4byte Unk_0812DAD8
_080FEC4C:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080FEC54
func_080FEC54: @ 0x080FEC54
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FED08: .4byte 0x0000FFF8
	...
	THUMB_FUNC_START func_080FED0C
func_080FED0C: @ 0x080FED0C
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FEDB8:
	...
	THUMB_FUNC_START func_080FEDC0
func_080FEDC0: @ 0x080FEDC0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FEDF8
func_080FEDF8: @ 0x080FEDF8
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FEE10
func_080FEE10: @ 0x080FEE10
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
...
_080FEECC: .4byte 0xFFFFF800
	...
	THUMB_FUNC_START func_080FEED0
func_080FEED0: @ 0x080FEED0
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FEF30:
	...
	THUMB_FUNC_START func_080FEF38
func_080FEF38: @ 0x080FEF38
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FEF58
func_080FEF58: @ 0x080FEF58
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
