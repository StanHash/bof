...
_080FE6DC:
	...
	b _080FE6FC
	.align 2, 0
_080FE6F4: .4byte Unk_0812DA50
_080FE6F8: .4byte Unk_0812DA70
_080FE6FC:
	ldr r0, [r7]
	bl func_080D7D08
	add sp, #4
...
_080FE78C:
	...
	b _080FE7AC
	.align 2, 0
_080FE7A4: .4byte Unk_0812DA88
_080FE7A8: .4byte Unk_0812DA70
_080FE7AC:
	add sp, #4
	pop {r4, r7}
	pop {r0}
	...
	THUMB_FUNC_START func_080FE7B4
func_080FE7B4: @ 0x080FE7B4
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FE876:
	...
	THUMB_FUNC_START func_080FE880
func_080FE880: @ 0x080FE880
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FE8B0
func_080FE8B0: @ 0x080FE8B0
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FE8F8
func_080FE8F8: @ 0x080FE8F8
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
	...
	THUMB_FUNC_START func_080FE910
func_080FE910: @ 0x080FE910
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080FE95C:
	...
	THUMB_FUNC_START func_080FE964
func_080FE964: @ 0x080FE964
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_080FE98A:
	...
	THUMB_FUNC_START func_080FE998
func_080FE998: @ 0x080FE998
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	str r0, [r7]
...
_080FE9EE:
	...
	THUMB_FUNC_START func_080FEA14
func_080FEA14: @ 0x080FEA14
	push {r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
...
_080FEA74:
	...
	THUMB_FUNC_START func_080FEA7C
func_080FEA7C: @ 0x080FEA7C
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
