...
typedef struct AgbPrintStruct AgbPrintStruct;

typedef void AgbPrintFlushFunc(void);

#define AGB_PRINT_FLUSH ((AgbPrintFlushFunc *)0x09FE209D)
#define AGB_PRINT_STRUCT ((AgbPrintStruct *)0x09FE20F8)
#define AGB_PRINT_PROTECT ((u16 *)0x09FE2FFE)

#define AGB_PRINT_WAITCNT_CONFIG (WAITCNT_PHI_OUT_16MHZ | WAITCNT_ROM_S_2 | WAITCNT_ROM_N_4)

void AgbPrintFlush1Block(void);

void AgbPrintInit(void)
{
    AgbPrintStruct * st = AGB_PRINT_STRUCT;
...
{
    AgbPrintStruct volatile * st = AGB_PRINT_STRUCT;
...
{
    AgbPrintFlushFunc * flush_func;
    u16 volatile * p_ime;
    u16 ime;
    u16 volatile * p_waitcnt;
    u16 waitcnt;
    u16 * protect;
    AgbPrintStruct volatile * st;
